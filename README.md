...
⦁	Includes: Region, State, City, Segment, Category, Product Name, Sales, Quantity, Profit, Discount, Ship Mode, Order Dates
...
⦁	Open Sales and Profit Dashboard.xlsx to view the dashboard.

⦁	Keep Sales Data Set for Dashboard.xlsx in the same folder so the pivot tables work correctly.

⦁	Use the slicers (Segment, Category, Ship Mode) to filter the dashboard data.

⦁	View dashboard-preview.png for a quick image of the dashboard.
